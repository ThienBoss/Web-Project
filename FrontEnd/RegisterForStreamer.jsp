...
<html>
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "styleStreamerRegister.css">
    ...
    <body>
        ...
        <br>
        <div>
            <image class="my-image" src ="https://samantree.com/wp-content/uploads/2020/01/Join-Us-Image-1920x720-1.png" width="800" height ="500">
        </div>
        ...
        <footer id="footer">
            <div class="main-footer typo-light">
                <div class="row">
                    <div class="widget">
                        <h5 class="widget-title">気持ち COMPANY<span></span></h5>
                        <p>Can someone make money by playing video games? 
                            <br>気持ち offers money making for both the company and the gamers. </p>
                    </div>
                    ...
                    <div class="widget">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="rentplayer.jsp">Rent Streamer</a>
                            </li>
                            <li>
                                <a href="buycard.jsp">Buy Card</a>
                            </li>
                            <li>
            ...
            <div class="footer-copyright">
                <div class="text-center">
                    <p>Copyright by 気持ち Company © 2020. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </body>
